...
//code from here http://svn.objectvision.nl/public/geodms/trunk/tic/tst/src/JenksTest.cpp
#include <assert.h>
#include <vector>
#include <algorithm>
#include <iostream>
...
// test code
std::vector<double> JenksNaturalBreak(std::vector<double> values, const int k)
{
    ...
    std::cout << sortedUniqueValueCounts.size();
